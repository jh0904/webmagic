...
public class Test2 implements PageProcessor{
    ...
    public static void main(String[] args){
        //系统配置文件
        System.setProperty("selenuim_config", "D:\\java\\WebMagicTest\\First\\config.ini");
        Spider.create(new Test2())
                .addUrl("http://pic.sogou.com/pics?query=%CD%BC%C6%AC&p=40230500&st=255&mode=255")	//要爬取的总链接
                .setDownloader(new SeleniumDownloader("D:\\ChromeDriver\\chromedriver_win32\\chromedriver.exe"))	//模拟启动浏览器
                .thread(2)	//线程
                .run();
    }
}